    ...
    <div className="text-white">
      <section className="text-center py-24 bg-gradient-to-r from-gray-900 to-gray-800">
        <h1 className="text-5xl font-bold mb-6">
          ...
          <span className="text-blue-500">Starting Rs.5,000</span>
        </h1>
        ...
        <button
          ...
          className="bg-blue-600 px-8 py-3 rounded-lg text-lg hover:bg-blue-700 transition"
        >
          Explore Properties
        </button>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-xl">
            ...
            <p className="text-gray-400">
              Start investing in premium properties with as low as Rs.5,000.
            </p>
          </div>
